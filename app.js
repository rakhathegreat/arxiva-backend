...
import {
	progressRouter as reconProgressRoutes,
	reportsRouter as reconReportsRoutes,
} from "./src/routes/recon.routes.js";
...
app.use("/recon-progress", reconProgressRoutes);
app.use("/recon-reports", reconReportsRoutes);
