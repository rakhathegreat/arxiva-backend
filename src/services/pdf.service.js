...
const getBastDocDefinition = (data) => {
	...
	return {
		...
		content: [
				...
				columns: [
					{
						...
						stack: [
							...
							{
								text: "Jl. WR.Supratman No.58 Bandung 40121 - Jawa Barat",
								style: "headerAddress",
								margin: [0, 4, 0, 0],
							},
				...
				table: {
					...
					body: [
						[
							...
							{
								text: "PLN ICON PLUS SBU Regional Jawa Barat (Bagian Inventori)",
								style: "normalText",
							},
						],
						[
						...
						[
							...
							{ text: ":", style: "normalText" },
							{
								text:
									title ||
									(partnerType
										? `${partnerType.charAt(0).toUpperCase() + partnerType.slice(1)} SBU Regional Jawa Barat`
			...
			// ===== DISCLAIMER =====
			{
				text: "Barang tersebut telah diterima oleh Pihak Kedua dari Pihak Pertama. Dokumen ini dibuat sebagai bukti penyerahan dan penerimaan barang serta dapat dipergunakan sebagaimana mestinya.",
				...
				columns: [
					{
						...
						stack: [
							...
							{
								text: kpName || generatedByName || "Admin",
								style: "signatureName",
								alignment: "center",
							},
						],
					},
					{
						...
						stack: [
							...
							signerSignatureUrl
								...
								: { text: " ", margin: [0, 28, 0, 28], alignment: "center" },
							{
								text: signerName || requesterName || "Unknown",
								style: "signatureName",
								alignment: "center",
							},
						],
